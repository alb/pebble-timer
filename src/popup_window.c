...
static void app_timer_vibe_callback(void *data) {
  ...
  if (num_vibes_left != 0) {
    // start vibration
    // pattern based on reveille alarm
    static const uint32_t vibe_seg[] = {
       111,  129,  105,  135,  102,   18,  105,   15,
       111,  129,  102,  138,  105,  135,  102,   18,
       105,   15,  111,  129,  102,  138,  105,  135,
       102,   18,  105,   15,  111,  129,  105,  135,
       222,  258,  105,  135,  111,  129,  105,  135,
       102,   18,  105,   15,  111,  129,  102,  138,
       105,  135,  102,   18,  105,   15,  111,  129,
       102,  138,  105,  135,  102,   18,  105,   15,
       111,  129,  111,  129,  465,  255,  102,  138,
       102,  138,  102,  138,  102,  138,  102,  138,
       220,  260,  102,  138,  102,  138,  102,  138,
       105,  135,  102,  138,  105,  135,  462,  258,
       102,  138,  102,  138,  102,  138,  102,  138,
       102,  138,  220,  260,  102,  138,  102,  138,
       105,  135,  102,   18,  105,   15,  111,  129,
       111,  129,  465,  495,
    };
